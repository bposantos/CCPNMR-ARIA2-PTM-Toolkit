...
residue ACY
  group
    atom C2  type=CH3E charge= 0.000 end
    atom H21 type=HA   charge= 0.000 end
    atom H22 type=HA   charge= 0.000 end
    atom H23 type=HA   charge= 0.000 end
    atom C1  type=C    charge= 0.500 end
    atom O   type=O    charge=-0.500 end

  bond C1  C2     bond C2 H21     bond C2 H22     bond C2 H23
  bond C1  O

  improper H21 H22 C1 H23  !methyl C2
...
residue NH2
  group
    atom N    type=NH2    charge=-0.850 end
    atom H    type=H      charge= 0.425 end
    atom "H'"   type=H    charge= 0.425 end
...
presidue PEPT     ! PEPTide bond link, for all except the  *(-) - (+)PRO link
  ...
  add improper -O  -C  +N  +CA                     ! 1st angle across peptide plane
  add improper +HN +N  -C  -CA                     ! 2nd angle across peptide plane
  add improper -CA -C  +N  +CA                     ! 3rd angle across peptide plane
...
presidue PEPP     ! for  ...*(-) - (+)PRO  link, same as PEPT except
  ...
  add improper -O  -C  +N  +CA                      ! 1st angle across peptide plane
  add improper +CD +N  -C  -CA                      ! 2nd angle across peptide plane
  add improper -CA  -C +N +CA                       ! 3rd angle across peptide plane
...
!patch cisp reference=-=(resid 36) reference=+=(resid 37) end
